...
RSpec.describe "instagram_posts/new", type: :view do
  before(:each) do
    assign(:instagram_post, InstagramPost.new(
      :user_id => 1,
      :instagram_user_id => 1,
      :media_id => "MyString",
      :media_type => "MyString",
  ...
  it "renders new instagram_post form" do
    render

    assert_select "form[action=?][method=?]", instagram_posts_path, "post" do
