...
RSpec.describe "instagram_users/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit instagram_user form" do
    render

    assert_select "form[action=?][method=?]", instagram_user_path(@instagram_user), "post" do
